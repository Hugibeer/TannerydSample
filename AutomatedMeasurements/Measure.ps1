...
for ($i = 0; $i -lt $numOfExecutions; $i++) {
    ...
    & $exe 1 bulk >> bulkoperations_1.txt
    & $exe 5 bulk >> bulkoperations_5.txt
    & $exe 10 bulk >> bulkoperations_10.txt
...
& $exe analyze bulkoperations_1.txt >> analysis_bulk1.txt
& $exe analyze bulkoperations_5.txt >> analysis_bulk5.txt
& $exe analyze bulkoperations_10.txt >> analysis_bulk10.txt
